...
function fish_prompt -d 'bobthefish, a fish theme optimized for awesome'
  ...
  set -l theme_left_prompts status vi vagrant docker k8s_context vaulted user desk rubies virtualfish virtualgo vcs
  __bobthefish_prompt $theme_left_prompts
